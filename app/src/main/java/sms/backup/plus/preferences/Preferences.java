...
import static sms.backup.plus.preferences.Preferences.Keys.APP_LOG;
...
import static sms.backup.plus.preferences.Preferences.Keys.DARK_THEME;
import static sms.backup.plus.preferences.Preferences.Keys.ENABLE_AUTO_BACKUP;
import static sms.backup.plus.preferences.Preferences.Keys.FIRST_USE;
import static sms.backup.plus.preferences.Preferences.Keys.INCOMING_TIMEOUT_SECONDS;
import static sms.backup.plus.preferences.Preferences.Keys.LAST_VERSION_CODE;
import static sms.backup.plus.preferences.Preferences.Keys.MAIL_SUBJECT_PREFIX;
import static sms.backup.plus.preferences.Preferences.Keys.MARK_AS_READ_ON_RESTORE;
import static sms.backup.plus.preferences.Preferences.Keys.MARK_AS_READ_TYPES;
import static sms.backup.plus.preferences.Preferences.Keys.MAX_ITEMS_PER_RESTORE;
import static sms.backup.plus.preferences.Preferences.Keys.MAX_ITEMS_PER_SYNC;
import static sms.backup.plus.preferences.Preferences.Keys.NOTIFICATIONS;
import static sms.backup.plus.preferences.Preferences.Keys.REFERENCE_UID;
import static sms.backup.plus.preferences.Preferences.Keys.REGULAR_TIMEOUT_SECONDS;
import static sms.backup.plus.preferences.Preferences.Keys.RESTORE_STARRED_ONLY;
import static sms.backup.plus.preferences.Preferences.Keys.SMS_DEFAULT_PACKAGE;
import static sms.backup.plus.preferences.Preferences.Keys.SMS_DEFAULT_PACKAGE_CHANGE_SEEN;
import static sms.backup.plus.preferences.Preferences.Keys.THIRD_PARTY_INTEGRATION;
...
public class Preferences {
    ...
    public enum Keys {
        ...
        DONATE("donate"),
        BACKUP_SETTINGS_SCREEN("sms.backup.plus.activity.fragments.AutoBackupSettings"),
